...
const initialPortfolioItems = [
  { 
    id: 1, 
    title: "Deepjyoti Das", 
    // --- CHANGE: Shortened description points to fit on a single line ---
 description: [ 
  ...
  // --- (The rest of your portfolio items remain the same) ---
  { id: 2, title: "Education", tag: "Academics", color: "bg-[#DDEADF]", colSpan: "lg:col-span-2", educationData: [ { title: "B.Tech, CSE", details: "Guru Gobind Singh Indraprastha University, New Delhi", year: "2023-2027", }, { title: "High School", details: "Kendriya Vidyalaya No.1, Assam", year: "2022", }, ], },
  { id: 3, title: "Skills", tag: "My Stack", color: "bg-[#FEE2D5]", colSpan: "lg:col-span-3", rowSpan: "lg:row-span-2", skillsData: [ { category: "Languages", items: [ { name: "JavaScript", icon: iconUrls.javascript }, { name: "C++", icon: iconUrls.cplusplus }, { name: "Python", icon: iconUrls.python }, ], }, { category: "Frontend", items: [ { name: "React", icon: iconUrls.react }, { name: "Tailwind", icon: iconUrls.tailwind }, { name: "HTML", icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg' }, { name: "CSS", icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg' }, ], }, { category: "Backend", items: [ { name: "Node.js", icon: iconUrls.node }, { name: "Express", icon: iconUrls.express }, ], }, { category: "Design & Tools", items: [ { name: "Figma", icon: iconUrls.figma }, { name: "Git", icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg' }, ], }, ], },
  { id: 4, title: "Interests", tag: "Hobbies", color: "bg-[#E4D7F0]", colSpan: "lg:col-span-2", interestsData: [ { id: 'gaming', icon: iconUrls.gaming, text: "Gaming" }, { id: 'traveling', icon: iconUrls.traveling, text: "Traveling" }, { id: 'cycling', icon: iconUrls.cycling, text: "Coding" }, { id: 'photography', icon: iconUrls.photography, text: "Photography" }, { id: 'music', icon: iconUrls.music, text: "Music" }, { id: 'movies', icon: iconUrls.movies, text: "Reading" }, ], },
  { id: 5, title: "I enjoy creating software solutions.", description: "", tag: "Passion", color: "bg-[#F3DCE3]", colSpan: "lg:col-span-2", },
  { id: 6, title: "Experience", tag: "Career", color: "bg-[#DDEEFE]", colSpan: "lg:col-span-5", experienceData: { left: [ { title: "Hackathon Project", subtitle: "GeeksforGeeks, Noida", year: "2024", details: [ "Developed 'Time Capsulator,' a full-stack MERN application.", "Engineered a seamless frontend-backend flow under deadlines.", ], }, { title: "UI/UX Lead", subtitle: "Robogyan Society, GGSIPU", year: "2024-Present", details: [ "Led all design initiatives for events.", "Mentored junior members in design principles.", ], }, ], right: [ { title: "Personal Projects", subtitle: "Self-Directed", year: "Ongoing", details: [ "Built multiple interactive web apps.", "Applied skills in HTML, CSS, and JavaScript.", ], }, { title: "Design Participant", subtitle: "Pixel Flow 2.0, IIIT Bangalore", year: "2024", details: [ "Gained hands-on experience in UI/UX challenges.", "Enhanced skills in design workflows.", ], }, ], }, },
  { id: 7, title: "Contact Details", tag: "Information", color: "bg-[#F0FFF4]", colSpan: "lg:col-span-5", contactItems: [ { id: 'email', icon: iconUrls.email, text: "deepjyoti478@gmail.com", link: "mailto:deepjyoti478@gmail.com" }, { id: 'phone', icon: iconUrls.phone, text: "+91 9899052055", link: "tel:+918822558069" }, { id: 'location', icon: iconUrls.indiaFlag, text: "India" }, ], },
];
